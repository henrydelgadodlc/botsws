...
const flatObject$2 = (listArray = []) => {
    ...
    const cbNestedObj = cbNestedList.map(({
        ctx
    }) => ctx ?.callbacks).filter((i) => !!i);
...
var hash = {
    generateRef: generateRef$8,
    generateRefSerialize: generateRefSerialize$2
};

const {
    generateRefSerialize: generateRefSerialize$1
} = hash;
...
var toSerialize_1 = {
    toSerialize: toSerialize$4
};

const {
    toSerialize: toSerialize$3
} = toSerialize_1;
/**
 * @deprecate
 * @param answer string
...
const {
    flatObject: flatObject$1
} = flattener;
const {
    generateRef: generateRef$7
} = hash;
const {
    addChild: addChild$2
} = addChild_1;
...
var addAnswer_1 = {
    addAnswer: addAnswer$3
};

const {
    generateRef: generateRef$6
} = hash;
const {
    addAnswer: addAnswer$2
} = addAnswer_1;
const {
    toJson: toJson$1
} = toJson_1;
...
var addKeyword_1 = {
    addKeyword: addKeyword$2
};

const {
    generateRef: generateRef$5,
...
const {
    addAnswer: addAnswer$1
} = addAnswer_1;
const {
    addKeyword: addKeyword$1
} = addKeyword_1;
const {
    addChild: addChild$1
} = addChild_1;
const {
    toSerialize: toSerialize$2
} = toSerialize_1;
const {
    toCtx: toCtx$1
} = toCtx_1;
...
var eventDocument_1 = {
    eventDocument: eventDocument$1,
    REGEX_EVENT_DOCUMENT: REGEX_EVENT_DOCUMENT$1
};

const {
    generateRef: generateRef$3
} = hash;
...
var eventLocation_1 = {
    ...
    REGEX_EVENT_LOCATION: REGEX_EVENT_LOCATION$1
};

const {
    generateRef: generateRef$2
} = hash;
...
var eventMedia_1 = {
    eventMedia: eventMedia$1,
    REGEX_EVENT_MEDIA: REGEX_EVENT_MEDIA$1
};

const {
    generateRef: generateRef$1
} = hash;
...
var eventVoiceNote_1 = {
    eventVoiceNote: eventVoiceNote$1,
    REGEX_EVENT_VOICE_NOTE: REGEX_EVENT_VOICE_NOTE$1
};
    ...
    handleMsg = async (messageCtxInComming) => {
        ...
        const continueFlow = async () => {
            ...
            if (!isContinueFlow) {
                ...
                if (nextChildMessages ?.length) return await sendFlow(nextChildMessages, from, {
                    prev: undefined
                })
            }

            if (!isContinueFlow) {
                await sendFlow(filterNextFlow, from, {
                    prev: undefined
                });
                return
            }
